...
public class AnimeController {
    ...
    @Operation(summary = "List all animes paginated",
            description = "The default size is 20, use the " +
                    "parameter size to change" +
                    " the default value",
            tags = {"anime"})
    ...
    public ResponseEntity<Anime> findByIdAuthenticateionPrincipal(@PathVariable long id,
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400",
                    description = "When Anime Does Not Exist in the DataBase"),
    })
